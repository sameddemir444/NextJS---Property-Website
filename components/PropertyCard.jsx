      ...
      <div className="p-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            ...
            className="h-[36px] bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-lg text-center text-base flex items-center justify-center duration-200 font-normal"
          >
            Details
          </Link>
        </div>
